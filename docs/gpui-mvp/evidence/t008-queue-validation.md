...
Task T008，dispatch GPUI-0012，attempt 1。基线是 T007 merge `c07ab1fb6c79debb0254f7948b878e1a48dd5ca7`。固定验收文档 ref：`2041a38756b87ba7856dcd343624d98df2283c5a`；不变更其门禁。

本地最终候选 12 项检查全部通过：GUI 全库 400 项、desktop 专项 130 项、核心全目标 270 项库测试及 1 项二进制测试，全部 0 ignored；fmt、核心/GUI Clippy（-D warnings）、GUI check/build、signal/net/transport 专项与 CLI build 均通过。
