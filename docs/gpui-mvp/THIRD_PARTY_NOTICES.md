...
src/desktop/mod.rs 中的 TextField 和 TextFieldElement 大段适配自
Zed Industries, Inc. 发布的 gpui v0.2.2/examples/input.rs。上游包的 Cargo.toml
声明许可证为 Apache-2.0，源码位置和版本固定如下：

- 上游仓库：https://github.com/zed-industries/zed
- 依赖版本：https://crates.io/crates/gpui/0.2.2
- 适配源路径：gpui v0.2.2/examples/input.rs
- 适配文件：src/desktop/mod.rs

本仓库对适配部分做了以下修改：重命名为 TextField，加入 T001 的窗口布局和
状态模型，加入原生路径选择器/剪贴板边界，修正 IME 选区相对坐标和陈旧布局处理，
使用 secondary-* 跨平台快捷键，并加入中文/emoji 回归测试。适配部分不应被描述为
本仓库 MIT 许可证下的原创代码；GPUI 的 Apache-2.0 条款对该部分继续适用。

以下保留上游 gpui 0.2.2 发布包中的 Apache License 2.0 文本。
...
Apache License
   ...
   1. Definitions.
      ...
      Object form, that is based on the Work and for which the editorial
   ...
   4. Redistribution. You may reproduce and distribute copies of the
      ...
      (d) If the Work includes a "NOTICE" text file as part of its
          ...
          Works, alongside or as an addendum to the NOTICE text from the Work,
